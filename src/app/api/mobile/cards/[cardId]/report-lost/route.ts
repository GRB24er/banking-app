...
// ADD THIS FILE TO YOUR WEB PROJECT: app/api/mobile/cards/[cardId]/report-lost/route.ts
...
export async function POST(
  ...
  console.log('[Mobile Cards Report Lost] POST request for card:', params.cardId);
